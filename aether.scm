...
(define-public aetherwm-git
  (package
    (name "aetherwm")
    (version "git")
    (source (local-file "." "aetherwm-checkout"
                        #:recursive? #t
          ...
          (add-before 'configure 'patch-meson
            (lambda _
              (substitute* "meson.build"
                ;; aetherWM ignores sysconfdir handling for NixOS.
    ...
    (home-page "https://github.com/aetherwm/aether")
