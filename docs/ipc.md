---
title: IPC
description: Control aetherwm programmatically using mmsg.
---

## Introduction

aetherwm includes a powerful IPC (Inter-Process Communication) tool called `mmsg`. This allows you to query the window manager's state, watch for events, and execute commands from external scripts.
