...
**aether** is a Wayland compositor based on [dwl](https://codeberg.org/dwl/dwl/). It aims to be as lightweight as `dwl` and can be built completely within a few seconds, without compromising on functionality.

> **Philosophy:** **Lightweight & Fast**: aether is designed to be minimal yet functional. It compiles in seconds and offers a robust set of features out of the box.

## Feature Highlights

Beyond basic window management, aetherwm provides a rich set of features designed for a modern Wayland experience.
...
- **[Join the aetherwm Discord](https://discord.gg/CPjbDxesh5)** — Chat with the community, get support, share your setup, and stay updated with the latest aetherwm news.
- **[Join the GitHub Discussions](https://github.com/aetherwm/aether/discussions)** — Ask questions, request features, report issues, or share ideas directly with contributors and other users.
