---
title: Configuration
description: Configure aetherwm with config files, environment variables, and autostart.
icon: Settings
---

Configure aetherwm through config files, environment variables, and autostart.
